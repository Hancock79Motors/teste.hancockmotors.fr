...
(function () {
  ...
  if (!document.getElementById('mobile-nav-styles')) {
    ...
    s.textContent = [
      ...
      '#mobile-menu .mob-link span:last-child { font-size: 1.6rem !important; line-height: 1.1 !important; }',
      '@media (min-width: 380px) { #mobile-menu .mob-link span:last-child { font-size: 1.85rem !important; } }',
      '@media (min-width: 480px) { #mobile-menu .mob-link span:last-child { font-size: 2.1rem !important; } }',
